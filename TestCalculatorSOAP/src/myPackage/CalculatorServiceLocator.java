...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements myPackage.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/CalculatorSOAP/services/Calculator";
    ...
    public myPackage.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            myPackage.CalculatorSoapBindingStub _stub = new myPackage.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (myPackage.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                myPackage.CalculatorSoapBindingStub _stub = new myPackage.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://myPackage", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://myPackage", "Calculator"));
        }
